...
目前看下来性能较高的方法就是动画蓝图直接与角色蓝图通信，修改状态量，也有另一种方法就是角色蓝图在Tick里检查动画蓝图状态，但最好的系统解耦方式是通过事件订阅和分发的方式动画蓝图只管广播，谁处理它并不关心。



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2NzU1NTYxMywxNTgwNDIwMzE4LC00ND
