...
8. **清除历史记录（Delete History）：** 模型制作过程中产生的建模历史会占用大量内存，且可能导致权重信息与旧的操作指令冲突。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxMzQxMjQ1LDQ1MzM0MzY3LDk1NTk4Nz
g2MywtNjU3Mzg3OTU1LC0xNTQ4NDQ4Mzg0LC0xMjQwMjkyNTM1
XX0=
-->